...
{
    [HideInInspector] public bool canDoAnAttack; //checks if boss can even an intiate an attack (ie call any of this yet)
    ...
    public void Attack()
    {
        probRandomAttack = UnityEngine.Random.Range(0, 1f);
